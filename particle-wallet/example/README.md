# particle_wallet_example

An example Flutter application demonstrating how to integrate and use the `particle_wallet` plugin for embedded wallet functionality.
